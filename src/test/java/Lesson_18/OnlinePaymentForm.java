...
public class OnlinePaymentForm {
    ...
    @FindBy(xpath = "//button[contains(text(), 'Îòêëîíèòü')]")
    ...
    @FindBy(xpath = "//div[@class = 'pay__partners']//img[@alt = 'Áåëêàðò']")
    private WebElement iconBelkart;

    @FindBy(xpath = "//div[@class = 'pay__wrapper']/a[text() = 'Ïîäðîáíåå î ñåðâèñå']")
    private WebElement linkMoreInfo;

    @FindBy(xpath = "//div[@class = 'select__wrapper']")
    private WebElement selector;

    @FindBy(xpath = "//li[contains(. , 'Óñëóãè ñâÿçè')]")
