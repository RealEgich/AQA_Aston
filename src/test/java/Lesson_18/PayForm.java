...
public class PayForm {
    ...
    @FindBy(xpath = "//span[contains(text(), 'Íîìåð')]")
    WebElement titlePhone;

    @FindBy(xpath = "//label[text() = 'Íîìåð êàðòû']")
    WebElement placeholderCreditCard;

    @FindBy(xpath = "//label[text() = 'Ñðîê äåéñòâèÿ']")
    WebElement placeholderExpirationDate;

    @FindBy(xpath = "//label[text() = 'CVC']")
    WebElement placeholderCVC;

    @FindBy(xpath = "//label[text() = 'Èìÿ äåðæàòåëÿ (êàê íà êàðòå)']")
